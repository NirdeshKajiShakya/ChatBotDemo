...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        schoolSearchService = SchoolSearchService(groqApiKey)
    ...
    private fun isValidApiKey(key: String): Boolean {
        // Groq API keys typically start with "gsk_" and are > 50 characters long
    ...
    private fun showApiKeyError() {
        ...
        chatBox.text = """
            ...
            Please add your Groq API key to local.properties:
            
            GROQ_API_KEY=your_groq_api_key_here
            
            To get a FREE API key (no credit card required):
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = if (schoolSearchService.isSchoolSearchQuery(message)) {
                    ...
                    """.trimIndent()
                    schoolSearchService.chatWithGroq(message, context)
                }
